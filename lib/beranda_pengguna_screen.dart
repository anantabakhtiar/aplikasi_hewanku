...
class BerandaPenggunaScreen extends StatelessWidget {
  const BerandaPenggunaScreen({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Temukanlah informasi layanan yang anda inginkan!',
                  style: GoogleFonts.poppins(
                    fontSize: 16,
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.pushNamed(
                            context, '/daftarLayananPetshopScreen');
                      },
                      child: Container(
                        height: 230,
                        padding: const EdgeInsets.only(top: 20, bottom: 20),
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.pushNamed(
                            context, '/daftarLayananPethelpScreen');
                      },
                      child: Container(
                        height: 230,
                        padding: const EdgeInsets.only(top: 20, bottom: 20),
                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: Text(
                              'Ingin beralih menjadi Penyedia Layanan?',
                              style: GoogleFonts.poppins(
