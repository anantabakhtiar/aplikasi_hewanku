...
class ProfilPenyediaScreen extends StatefulWidget {
  const ProfilPenyediaScreen({super.key});

  @override
  State<ProfilPenyediaScreen> createState() => _ProfilPenyediaScreenState();
}

class _ProfilPenyediaScreenState extends State<ProfilPenyediaScreen> {
  // ignore: unused_field
  File? _image;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            onPressed: () {
              Navigator.pushNamed(context, '/editProfilPenyediaScreen');
            },
            icon: const Icon(
              Icons.edit_rounded,
              color: Colors.white,
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () {
                  Navigator.pushNamed(context, '/editPasswordPenyediaScreen');
                },
              ),
              const SizedBox(
                height: 20,
