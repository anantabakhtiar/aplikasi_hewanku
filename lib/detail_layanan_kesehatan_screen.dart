...
class DetailLayananKesehatanScreen extends StatefulWidget {
  const DetailLayananKesehatanScreen({super.key});

  @override
  State<DetailLayananKesehatanScreen> createState() =>
      _DetailLayananKesehatanScreenState();
}

class _DetailLayananKesehatanScreenState
    extends State<DetailLayananKesehatanScreen> {
  bool pinned = false;
  @override
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        IconButton(
                          onPressed: () {
                            Navigator.pushNamed(
                                context, '/daftarLayananKesehatanScreen');
                          },
                          icon: const Icon(
