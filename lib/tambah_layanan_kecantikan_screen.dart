...
class TambahLayananKecantikanScreen extends StatefulWidget {
  const TambahLayananKecantikanScreen({super.key});

  @override
  State<TambahLayananKecantikanScreen> createState() =>
      _TambahLayananKecantikanScreenState();
}

class _TambahLayananKecantikanScreenState
    extends State<TambahLayananKecantikanScreen> {
  // ignore: unused_field
  File? _image;
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                'Isilah dan beri informasi yang benar kepada pengguna tentang salonmu disini!',
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Masukkan layanan salon',
                    hintStyle: GoogleFonts.poppins(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: const Color.fromARGB(100, 0, 0, 0),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Masukkan tentang salon',
                    hintStyle: GoogleFonts.poppins(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: const Color.fromARGB(100, 0, 0, 0),
