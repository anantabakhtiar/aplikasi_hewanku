...
class DetailPesanPenyediaScreen extends StatefulWidget {
  const DetailPesanPenyediaScreen({super.key});

  @override
  State<DetailPesanPenyediaScreen> createState() =>
      _DetailPesanPenyediaScreenState();
}

class _DetailPesanPenyediaScreenState extends State<DetailPesanPenyediaScreen> {
  // ignore: unused_field
  File? _image;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          color: Colors.white,
          onPressed: () {
            Navigator.pushNamed(context, '/daftarPesanPenyediaScreen');
          },
          icon: const Icon(
