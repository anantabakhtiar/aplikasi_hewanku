...
class DetailLayananPetshopScreen extends StatefulWidget {
  const DetailLayananPetshopScreen({super.key});

  @override
  State<DetailLayananPetshopScreen> createState() =>
      _DetailLayananPetshopScreenState();
}

class _DetailLayananPetshopScreenState
    extends State<DetailLayananPetshopScreen> {
  bool pinned = false;
  @override
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, '/daftarProdukScreen');
                  },
                  child: Container(
                    height: 50,
                    decoration: BoxDecoration(
