...
class UbahLayananKesehatanScreen extends StatefulWidget {
  const UbahLayananKesehatanScreen({super.key});

  @override
  State<UbahLayananKesehatanScreen> createState() =>
      _UbahLayananKesehatanScreenState();
}

class _UbahLayananKesehatanScreenState
    extends State<UbahLayananKesehatanScreen> {
  // ignore: unused_field
  File? _image;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushNamed(
                context, '/detailLayananKesehatanPenyediaScreen');
          },
          icon: const Icon(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                'Isilah dan beri informasi yang benar kepada pengguna tentang klinikmu disini!',
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Masukkan layanan klinik',
                    hintStyle: GoogleFonts.poppins(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: const Color.fromARGB(100, 0, 0, 0),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            width: 80,
                            child: Image.asset(
                              'images/FotoLayananKesehatan.jpg',
                              fit: BoxFit.cover,
                            ),
                          ),
                          Container(
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Masukkan tentang klinik',
                    hintStyle: GoogleFonts.poppins(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: const Color.fromARGB(100, 0, 0, 0),
