...
class DetailLayananPethelpScreen extends StatefulWidget {
  ...
  @override
  State<DetailLayananPethelpScreen> createState() =>
      _DetailLayananPethelpScreenState();
}
              ...
              IconButton(
                ...
                icon: Icon(
                  pinned
                      ...
                      : CupertinoIcons.bookmark_fill,
                  color: pinned ? Colors.white : Colors.red.withOpacity(0.9),
                ),
              ),
            ],
          )
