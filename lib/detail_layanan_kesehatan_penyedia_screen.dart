...
class DetailLayananKesehatanPenyediaScreen extends StatelessWidget {
  const DetailLayananKesehatanPenyediaScreen({super.key});
                        ...
                        IconButton(
                          onPressed: () {
                            Navigator.pushNamed(context,
                                '/daftarLayananKesehatanPenyediaScreen');
                          },
                          icon: const Icon(
