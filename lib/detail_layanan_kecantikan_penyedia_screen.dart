...
class DetailLayananKecantikanPenyediaScreen extends StatelessWidget {
  const DetailLayananKecantikanPenyediaScreen({super.key});
                        ...
                        IconButton(
                          onPressed: () {
                            Navigator.pushNamed(context,
                                '/daftarLayananKecantikanPenyediaScreen');
                          },
                          icon: const Icon(
